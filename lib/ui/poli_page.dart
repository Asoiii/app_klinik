    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          GestureDetector(
            child: Card(
              child: ListTile(title: const Text("Poli Anak")),
            ),
            onTap: () {
          ...
          GestureDetector(
            child: Card(
              child: ListTile(title: const Text("Poli Kandungan")),
            ),
            onTap: () {
          ...
          GestureDetector(
            child: Card(
              child: ListTile(title: const Text("Poli Gigi")),
            ),
            onTap: () {
          ...
          GestureDetector(
            child: Card(
              child: ListTile(title: const Text("Poli THT")),
            ),
            onTap: () {
